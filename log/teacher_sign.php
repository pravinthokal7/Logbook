...
<form class="login" method="POST" action="teacher_create.php">
    <h1 class="login-title">Teacher Sign Up</h1>
    ...
    <input type="password" class="login-input" placeholder="Confirm Password" name="cpsw">
    <input type="submit" value="Sign Up" class="login-button">
  <p class="login-lost"><a href="login.php">Student Login?</a></p>
  <p class="login-lost"><a href="teacher.php">Already Have account?</a></p>
  </form>
